...
import time
import random  # 新增
from rec_agent_experiment.gemini import GeminiLLM
...
if __name__ == "__main__":
    ...
    with open(
        # f"./evaluation_results_track2_{task_set}_baseline_k{k}_rs{seed}.json", "w"
        f"./evaluation_results_track2_{task_set}_baseline_full_seed{seed}_task#{k}.json",
        "w",
    ) as f:
